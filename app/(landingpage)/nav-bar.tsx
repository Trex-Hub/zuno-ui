...
const NavBar = () => {
  return (
    <header data-oid="g1jgiz9">
      <nav
        className="absolute inset-x-0 top-0 z-50 mx-auto flex h-20 w-full max-w-7xl items-center gap-6 px-6"
        data-oid="hazzzkf"
      >
        <a
          href="#"
        ...
        <div className="hidden gap-2 lg:inline-flex" data-oid="0zs1f4g">
          {navItems.map((item: NavItem) => (
            <Button
              ...
              data-oid="c6snjwl"
            >
              <a href={item.href} data-oid="deuos98">
                {item.title}
              </a>
            </Button>
          ))}
        ...
        <div
          className="hidden flex-1 justify-end gap-2 lg:inline-flex"
          data-oid=":5w.gzb"
        >
          <Button data-oid="xw_sa4u"></Button>
        </div>
        <Sheet data-oid="_xvs_6i">
          <SheetTrigger
            asChild
          ...
          >
            ...
            <nav
              className="-mx-4 my-6 flex flex-1 flex-col gap-2"
              data-oid=":0dqa.p"
            >
              {navItems.map((item: NavItem) => (
                <Button
                  ...
                  data-oid="_2u7mp."
                >
                  <a href={item.href} data-oid="nixj88f">
                    {item.title}
                  </a>
                </Button>
              ))}
            </nav>
            <div className="mt-auto grid gap-2" data-oid="9tpdalt">
              <Button variant={"outline"} asChild data-oid="dmxoa4_">
                <a href="#" data-oid="kd1kpjn">
                  Log in
                </a>
              </Button>
              <Button asChild data-oid="vxq0fu1">
                <a href="#" data-oid="maz064c">
                  Get Started
                </a>
              </Button>
            </div>
